...
from rl_algorithms.src.vpg.vpg import run_model
...
def run_cartpole(exp_name="vpg-cartpole", seed=1, debug=True):
...
def run_inverted_pendulum(exp_name="vpg-inverted-pendulum", seed=1, debug=True):
...
def run_half_cheetah(exp_name="vpg-half-cheetah", seed=1, debug=False):
